...
<html>
<head>
    <link rel="stylesheet" href="/resources/Frontend/css/cartTable.css">
    <style>
        html
        {
            font-size: 100%;
            ...
            <table class="table-cart-checkout mytable table-convert-price" >
                ...
                <c:forEach var="product" items="${cart}" varStatus="loop">
                    <tr class="cart_line" id="item${product.id}">
                        <div>
                            <td>${loop.index+1}</td>
                            <td><img src="/bookshop/img/${product.id}.png" style="width: 150px" class="cart-img"></td>
                            <td style="text-align: center; mergin-top: -52px;">
                                <p class="cart_ten"><a href="<c:url value="/bookshop/product?id=${product.id}" />">${product.nameProduct}</a></p>
                ...
                <tr>
                    <c:if test="${checkEmpty != 0 }">
                        <td colspan="3">
                            ...
                            &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            <a class="btn btn-warning " href="<%=request.getContextPath()%>/bookshop/checkout"><span class="glyphicon glyphicon-check"></span> Thanh toán</a>
                        </td>
                    </c:if>
...
<script src="<c:url value='/resources/js/client/cartAjax.js'/>" ></script>
